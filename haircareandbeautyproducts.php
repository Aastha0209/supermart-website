...
// Fetch products for Haircare and Beauty category
$sql = "SELECT * FROM products WHERE category_id = (SELECT id FROM categories WHERE name = 'Haircare and beauty products')";
...
<head>
    ...
    <title>Haircare and Beauty Products</title>
    <style>
...
<main>
    <h2>Haircare and Beauty Products</h2>
