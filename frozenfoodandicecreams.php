...
// Fetch products for Frozen food and ice creams category
$sql = "SELECT * FROM products WHERE category_id = (SELECT id FROM categories WHERE name = 'Frozen food and ice creams')";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['product_id'])) {
    ...
    $product_quantity = 1; // Default quantity is 1 (or you can use a form input to change it)
    ...
    // Redirect to the same page or cart page after adding to cart
...
<head>
    ...
    <title>Frozen Food and Ice Creams</title>
    <style>
...
<main>
    <h2 style="text-align: center; margin: 20px 0;">Frozen Food and Ice Creams</h2>
    ...
    <div class="product-grid">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                // Buy Now Form
                if ($isGuest) {
                    echo '<a href="login.php" class="buy-now-btn">Buy Now</a>';
                } else {
